...
var getRedfishDeviceResponse = function(nodeid, req) {
    ...
    .catch(function(err) {
        return redfish.handleError("Not implemented for this device.", err, null, 501);
    });
  // try { 
  //     return dataFactory(nodeid,source);
  // } catch(err) {
  //     return redfish.handleError("Not implemented for this device.", res, null, 501);
  // }  
};
...
var listSystems = controller(function(req, res) {
    ...
    return nodeApi.getAllNodes({type: 'compute'}).then(function(nodes) {
        options.nodes = nodes;
        console.log("BHLD ************** "+ JSON.stringify(options, null, 4));
